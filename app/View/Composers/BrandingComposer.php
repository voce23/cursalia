...
class BrandingComposer
{
    ...
    /** Una sola clave de caché para TODO el branding (antes eran 8). */
    private const BUNDLE_KEY = 'branding.bundle';

    public function compose(View $view): void
    {
        // OPTIMIZACIÓN: una única lectura de caché por request en vez de 8.
    ...
    {
        // Un solo bundle ahora. Mantenemos las claves antiguas en el forget por
        // compatibilidad (si quedaron en caché de una versión previa).
        Cache::forget(self::BUNDLE_KEY);
        foreach ([
