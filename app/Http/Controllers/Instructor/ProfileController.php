...
use App\Http\Requests\Instructor\PasswordUpdateRequest;
use App\Http\Requests\Instructor\ProfileUpdateRequest;
use App\Http\Requests\Instructor\SocialUpdateRequest;
use App\Models\User;
...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        $data = $request->only('name', 'email', 'headline', 'slogan', 'phone', 'gender', 'bio');
