                ...
                @php
                    ...
                    $groups = [
                        ...
                        'Sistema' => [
                            ...
                            ['admin.migrador.index', 'fa-truck-fast', 'Migrador PRO', false],
                            ['admin.image-tools.index', 'fa-images', 'Optimizar imágenes', false],
                            ['admin.certificates.index', 'fa-award', 'Certificados PRO', false],
