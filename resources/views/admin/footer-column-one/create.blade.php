...
@section('title', 'Nuevo enlace · Columna 1')
@section('page-title', 'Nuevo enlace · Columna 1')
...
<form method="POST" action="{{ route('admin.footer-column-one.store') }}" class="max-w-2xl space-y-5">
    @csrf
