...
@section('title', 'Editar enlace · Columna 2')
@section('page-title', 'Editar enlace · Columna 2')
...
<form method="POST" action="{{ route('admin.footer-column-two.update', $item) }}" class="max-w-2xl space-y-5">
    @csrf @method('PUT')
